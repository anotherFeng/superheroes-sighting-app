                ...
                <table class="table table-hover">
                    ...
                    <c:forEach var="location" items="${locations}">
                        <tr>
                            <td></td>
                            <td>
                                <a href="${pageContext.request.contextPath}/retrieval/displayLocationDetails?locationId=${location.locationId}">
                                    <c:out value="${location.locationName}"/>
                                </a>
                            </td>
                            <td>
                                <a class="glyphicon glyphicon-pencil white" 
                                    href="${pageContext.request.contextPath}/edit/displayEditLocation?locationId=${location.locationId}">
                                </a>
                            </td>
                            <td>
                                <a class="glyphicon glyphicon-trash white"
                                    href="${pageContext.request.contextPath}/delete/location?locationId=${location.locationId}"
