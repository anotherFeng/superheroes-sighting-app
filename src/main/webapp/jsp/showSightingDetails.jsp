...
<html>
    ...
    <body>
        ...
        <div class="row text-center">
            <label>Hero: </label>
                <a href="${pageContext.request.contextPath}/retrieval/displayHeroDetails?heroId=${sighting.hero.heroId}">
                <c:out value="${sighting.hero.alias}"/><br>
                </a>
        </div>
        <div class="row text-center">
            <label>Location: </label>
                <a href="${pageContext.request.contextPath}/retrieval/displayLocationDetails?locationId=${sighting.location.locationId}">
                <c:out value="${sighting.location.locationName}"/><br>
                </a>
        </div>                
