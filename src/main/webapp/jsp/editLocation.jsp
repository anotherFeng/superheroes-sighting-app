                ...
                <sf:form class="form-horizontal" role="form" modelAttribute="location" action="editLocation" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="locationName"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="latitude"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="longitude"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.address"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.city"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.state"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.country"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.zip"/>
                        </div>
                    </div>           
                    <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12 control-label">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <sf:input type="type" class="add-form form-control" path="address.world"/>
                        </div>
                    </div>           
