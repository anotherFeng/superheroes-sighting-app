                        ...
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/retrieval/displayPowerDetails?powerId=${power.powerId}">
                                    <c:out value="${power.power}"/>
                                </a>
                            </td>
                            <td>
                                <a class="glyphicon glyphicon-pencil white" 
                                    href="${pageContext.request.contextPath}/edit/displayEditPower?powerId=${power.powerId}">
                                </a>
                            </td>
                            <td>
                                <a class="glyphicon glyphicon-trash white"
                                    href="${pageContext.request.contextPath}/delete/power?powerId=${power.powerId}"
                                    onclick="return confirm('Are you sure you want to delete this power? All Heroes will lose this power.');">
                                </a>
                            </td>
                            <td></td>
                        </tr>
